...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_posts_content_type" AS ENUM('article', 'research-report', 'tool-guide', 'market-brief');
  ...
  CREATE TABLE "posts" (
  	...
  	"title" varchar NOT NULL,
  	"slug" varchar NOT NULL,
  	"content_type" "enum_posts_content_type" DEFAULT 'article' NOT NULL,
  	"author_id" integer NOT NULL,
  	"content" jsonb NOT NULL,
  	"excerpt" varchar,
  	"category_id" integer NOT NULL,
  	"reading_time" numeric,
  	"difficulty" "enum_posts_difficulty" DEFAULT 'intermediate',
  	"series_id" integer,
  	"series_order" numeric DEFAULT 0,
  	...
  	"provenance_source_agent" varchar,
  	"provenance_source_doc" varchar,
  	"provenance_source_session" varchar,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
